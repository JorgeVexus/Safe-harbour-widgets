(function () {
  ...
  var ROOT_ID = 'shi-testimonials-slider-root';
  var S = '#' + ROOT_ID;
  ...
  var testimonials = [
    {
      title: '"A single phishing email nearly cost us everything. Today, our board calls it the moment we went from panic to protection."',
      rating: 5,
      body: 'After a phishing attack led to a $150,000 loss with more at risk, Safe Harbour’s rapid response team stepped in. They stopped the fraudulent transfers, secured our systems, and led a complete security overhaul to restore compliance. Their expert guidance was critical in a moment of crisis.',
      role: 'CIO',
      company: 'Airport authority'
    },
    {
      title: '"A cyber breach crippled our global network, halting operations and costing us over a million dollars each day."',
      rating: 5,
      body: 'Despite our warnings, a ransomware attack brought their systems down. When the client\'s internal team was overwhelmed, our CISSP-certified expert stepped in to lead the response. After an intense 24 hours, we successfully restored systems and brought their global operations back online.',
      role: 'VP OF OPERATIONS',
      company: 'Global Manufacturing Firm'
    },
    {
      title: '"We secured the contract because we were cyber-ready. Our competitor wasn\'t."',
      rating: 5,
      body: 'While other businesses lose major contracts due to non-compliance, Safe Harbour ensured we met every cybersecurity requirement from day one. Their proactive approach didn\'t just protect us from threats—it positioned us to win transformative opportunities.',
      role: 'Owner',
      company: 'Government Supply Contractor'
    }
  ];
